...
<div class="container mt-4">
    ...
    <a href="{{ route('albums.create') }}" class="btn btn-primary mb-3">Voeg Album Toe</a>

    <div class="row row-cols-1 row-cols-md-3 g-4">
        @foreach ($albums->where('users_id', Auth::id()) as $album)
            <div class="col mb-3">
                    ...
                    <p class="card-text">
                        <small class="proffoto d-flex align-items-center" style="margin-bottom: -10px;">
                            @if ($album->user)
                                ...
                                <span class="font-weight-bold" style="color: #333; margin-top: 10px; margin-right: 7px;">
                                    {{ $album->user->name }}
                                </span>
                            @endif
                        </small>
